...
from skymarket.ads.serializers import CommentListSerializer, CommentSerializer, CommentCreateSerializer, \
    AdListSerializer, AdRetrieveSerializer, AdCreateSerializer
...
class AdViewSet(ModelViewSet):
    ...
    def user_ads(self, request, *args, **kwargs):
        ...
        serializer = self.get_serializer(Ad.objects.all(), many=True)
